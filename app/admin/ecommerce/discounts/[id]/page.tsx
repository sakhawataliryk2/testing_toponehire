...
export default function EditDiscountPage() {
      ...
      try {
        ...
        if (data.discount) {
          ...
          setForm({
            ...
            maxUsesPerUser: String(d.maxUsesPerUser ?? 1),
  ...
  if (loading) {
    return (
      <AdminLayout>
        <div className="p-10 text-[13px] text-[#666]">Loading...</div>
      </AdminLayout>
    );
  }
      ...
      <div className="min-h-screen bg-[#f8f9fc] p-8 font-sans">
        <div className="mb-8">
          <div className="flex items-center gap-2 text-[11px] text-[#666] mb-4">
            ...
            <span>/</span>
            <span className="bg-[#f0f1f3] px-2 py-0.5 rounded text-[#333]">Edit Discount Code</span>
          </div>
          <h1 className="text-2xl font-medium text-[#4a4a4a]">Edit Discount Code</h1>
        </div>
